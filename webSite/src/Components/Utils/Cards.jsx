...
const Cards = () => {
    ...
    return (
        <div className="flex justify-center items-center m-0 ">
            <div
                className="gradiantBackground w-2/3 h-56 border-2 dark:border-Cream border-background border-opacity-15  p-1 rounded-3xl 
                ...
                >
                    <div className="content  ">
                        ...
                        <div className="rightSide backdrop-blur-[2px] z-10 relative py-96">
                            <h2 className="text-center dark:text-Cream text-background font-bold text-xl md:text-4xl mb-9 md:mb-10 mt-4 md:mt-0">
                                Our use of AI{" "}
                            </h2>
                            <h3 className="text-center dark:text-Cream text-background font-light text-sm md:text-xl  px-8">
