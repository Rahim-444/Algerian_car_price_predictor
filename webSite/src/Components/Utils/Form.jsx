          ...
          <div className="input stroke-fuchsia-500">
            <form onSubmit={handleSubmit}>
              {form[step] && form[step].type === "choice" ? (
                ...
                form[step].options.map((option, index) => {
                  const bgColor = index % 2 === 0 ? "bg-Purple" : "bg-blue-500";
                  return (
                    <div
                      key={index}
                    ...
                    >
                      <input
                        ...
                        className={`appearance-none bg-white border border-gray-300 checked:${bgColor} checked:border-transparent focus:outline-none h-6 w-6 rounded ml-4`}
