 ...
 import RightBackground from "../assets/robot.svg";
...
//   }, []);
        ...
        return (
            <div className="hero overflow-hidden ">
                <div className="hero-content w-screen h-screen  flex justify-center lg:justify-between  items-center relative">
                     <img src={dots} className='dots absolute top-14 left-7'/>
                    <div className="left-side ml-7 lg:ml-44 z-10  ">
                        <div className='text '>
                    ...
                    <div className='right-side flex justify-center items-center'>
                      <img src={RightBackground} className=''/>
