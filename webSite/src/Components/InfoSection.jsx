...
const InfoSection = () => {
  ...
  return (
    <div className='Info-section h-screen relative flex justify-center items-center '>
       <div className='bg-Blue blur-[100px] w-40 h-48 absolute top-10 left-24 z-10'></div>
